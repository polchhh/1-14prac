...
cartIcon.addEventListener('dragover', function(event) {
...
const cards = document.querySelectorAll('.card2[data-id]');
...
cards.forEach(card => {
    ...
    card.addEventListener('dragstart', function(event) {
        ...
        event.dataTransfer.setData('text/plain', JSON.stringify(productInfo));
    });
});

cartIcon.addEventListener('drop', function(event) {
    event.preventDefault();
